...
// =============================================================================
// soko-frontend/src/components/layout/NavItem.vue (UPDATED)
// =============================================================================
...
interface Props {
  to: { name: string };
  label: string;
  icon: Component; // Accepts Lucide icon components directly
}
...
function isActive(): boolean {
  ...
  if (props.to.name === 'products' && route.name === 'products-add') return true;
